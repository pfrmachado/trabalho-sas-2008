...
public class FacadeSimpleSASTest {
	...
	public void testAssinaString() {
		FacadeSimpleSAS facade = new FacadeSimpleSAS("res/repositorio.jce", "sas", "JCEKS",  "sas123");
		Signature sig=null;
	...
	public void testCriptografaDesStringStringByteArray() {
		...
		try {
			...
			byte[] criptografada = facade.criptografaDes("secretalias", "secret123", mensagem);
			assertEquals(toHex(mensagem), toHex(facade.descriptografaDes("secretalias", "secret123", criptografada)));
		} catch (Exception e) {
			fail("Nao foi possivel Criptografar string!");
			e.printStackTrace();
		}
	...
	public void testCriptografaDesStringStringStringString() {
		...
		try {
			//chave simetrica do banco ("novachave")
			facade.criptografaDes("secretalias", "secret123", "res/teste.txt", "res/facadetestdes.txt" );
			facade.descriptografaDes("secretalias","secret123" , "res/facadetestdes.txt", "res/descfacadetestdes.txt" );
	...
	public void testGetSecretKey() {
		try {
			FacadeSimpleSAS facade = new FacadeSimpleSAS("res/repositorio.jce", "sas", "JCEKS",  "sas123");
			facade.getSecretKey("secretalias", "secret123");
			assertEquals("df5885f8a1dc9243",toHex(facade.getSecretKey("secretalias", "secret123").getEncoded()));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void testGetKeyPair() {
		try {
			...
			kp =facade.getKeyPair("sascert", "sascert123"); 
