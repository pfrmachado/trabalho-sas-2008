...
//			System.out.println(toHex(repositorio.getPrivateKey("sas", "sas123").getEncoded()));
	...
	public void testGetSecretKey() {
		...
		try {
			repositorio = new RepositorioImpl("res/sas.jks", "sas", "JCEKS",  "sas123");
			repositorio.getSecretKey("novachave", "sas123");
			
			assertEquals("13abda3e3d10f113",toHex(repositorio.getSecretKey("novachave", "sas123").getEncoded()));
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//			System.out.println(toHex(repositorio.getPrivateKey("sas", "sas123").getEncoded()));
			kp =repositorio.getKeyPair("sas", "sas123"); 
